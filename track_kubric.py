...
def read_kurbic_rgb(view_path:str):
    
  video = read_images_from_directory(dir = view_path, prefix = 'rgb')
...
def run_track(vid: str, save_root: str):
  ...
  """
  # Read the video.
  video = read_kurbic_rgb(osp.join(save_root, vid))
...
def main():
  ...
  for idx in range(args.num_views):
    ...
    run_track(f'view_{idx}', args.dir)
