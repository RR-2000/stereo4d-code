...
def read_arctic_rgb(view_path:str):
    
  video = read_images_from_directory(dir = view_path, prefix = None)
...
def run_track(vid: str, save_root: str):
  ...
  """
  # Read the video.
  video = read_arctic_rgb(osp.join(save_root, vid))
